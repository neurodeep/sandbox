...
; There's one to open Volume Mixer, Notepad, Dual Wallpaper, turning the volume up and down, playing and pausing mpc (mpc doesn't need to be active, how gr8), showing and hiding titlebars and moving windows by holding down alt with the left mouse button (basically AltDrag).
...
#w::
    Run "C:\Program Files (x86)\Dual Monitor Tools\DualWallpaper.exe"
    Return    
